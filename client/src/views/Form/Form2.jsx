...
const Form2 = () => {
  ...
  const [showAlert, setShowAlert] = useState({created : false, message : ""});
  const handleCloseAlert = () => {
    setShowAlert({created : false, message : ""});
  };
  ...
  <div className={style.container}>
    ...
    <div>
      <label htmlFor="name">Name: </label>
			<input className={style.input} type="search" name="name" value={form.name} onChange={updateForm} placeholder="Put your dog name" />
    </div>
    ...
    <span>inchs</span>
    {form.maxHeight > 50 && <h5 className={style.warning}>Are you creating a dinosaur?</h5>}
    <br />
    ...
    <span>pounds</span>
    {form.maxWeight > 250 && <h5 className={style.warning}>Are you creating a dinosaur?</h5>}
    <br />
    ...
    {/* LIVE_SPAN */}
			...
			<br />
			{/* TEMPERAMENT */}
        {form.temperamentId.length === 0 && <p className={style.warning}>Select almost one temperament</p>}
      ...
      <hr />
			<div
				...
				<table style={{ justifyContent: "center" }}>
					<thead>
						<tr>
							<th colspan="20">So is your dog?</th>
						</tr>
					</thead>
					<tr>
						<td>Name</td>
    ...
    {showAlert && <Message message={setShowAlert.message} onClose={handleCloseAlert}/>}
    </div>
